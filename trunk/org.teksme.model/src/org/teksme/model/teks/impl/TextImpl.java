 ...
 * <ul>
 *   <li>{@link org.teksme.model.teks.impl.TextImpl#getAnswer <em>Answer</em>}</li>
 *   <li>{@link org.teksme.model.teks.impl.TextImpl#getKeyword <em>Keyword</em>}</li>
 *   <li>{@link org.teksme.model.teks.impl.TextImpl#isAutoKeyword <em>Auto Keyword</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public abstract class TextImpl extends ChoiceImpl implements Text {
	/**
		...
		if (answer != null && answer.eIsProxy()) {
			...
			if (answer != oldAnswer) {
				...
				NotificationChain msgs = oldAnswer.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - TeksPackage.TEXT__ANSWER,
						null, null);
				if (newAnswer.eInternalContainer() == null) {
					msgs = newAnswer.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
							- TeksPackage.TEXT__ANSWER, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TeksPackage.TEXT__ANSWER, oldAnswer, answer));
			}
		}
		return answer;
	}
	...
	public NotificationChain basicSetAnswer(Answer newAnswer,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, TeksPackage.TEXT__ANSWER, oldAnswer,
					newAnswer);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setAnswer(Answer newAnswer) {
		if (newAnswer != answer) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeksPackage.TEXT__ANSWER, newAnswer, newAnswer));
	}
	...
	public void setKeyword(String newKeyword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeksPackage.TEXT__KEYWORD, oldKeyword, keyword));
	}
	...
	public void setAutoKeyword(boolean newAutoKeyword) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeksPackage.TEXT__AUTO_KEYWORD, oldAutoKeyword, autoKeyword));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case TeksPackage.TEXT__KEYWORD:
			return getKeyword();
		case TeksPackage.TEXT__AUTO_KEYWORD:
