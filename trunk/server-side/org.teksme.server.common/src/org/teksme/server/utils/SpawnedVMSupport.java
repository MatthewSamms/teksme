...
package org.teksme.server.utils;
...
public class SpawnedVMSupport {
	...
	// Logger.getLogger(SpawnedVMSupport.class);

	// Attributes ----------------------------------------------------

	// Static --------------------------------------------------------
	public static Process spawnVM(final String classPath, final String className, final String vmargs, final boolean logOutput,
			final String success, final String failure, final String configDir, final String... args) throws Exception {
		return SpawnedVMSupport.spawnVM(classPath, "HornetQServer", className, vmargs, logOutput, success, failure, configDir, args);
	}

	public static Process spawnVM(String classPath, final String logName, final String className, final String vmargs,
			final boolean logOutput, final String success, final String failure, final String configDir, final String... args)
			throws Exception {
	...
	static class ProcessLogger extends Thread {
		...
		ProcessLogger(final boolean print, final InputStream is, final String logName, final boolean sendToErr, final String success,
				final String failure, final CountDownLatch latch) throws ClassNotFoundException {
			this.is = is;
			this.print = print;
