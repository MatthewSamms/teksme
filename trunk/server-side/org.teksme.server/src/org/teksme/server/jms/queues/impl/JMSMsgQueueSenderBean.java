...
// @Stateless(name = "JMSOutboundMsgQueueSender", mappedName =
// JMSMsgQueueSender.JNDI_NAME)
public class JMSMsgQueueSenderBean implements JMSMsgQueueSender {

	private static final String MESSAGETYPE_OBJECT = OutboundTextMessage.class.getName();
