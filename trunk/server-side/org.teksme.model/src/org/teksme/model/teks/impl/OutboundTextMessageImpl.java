 ...
 *   <li>{@link org.teksme.model.teks.impl.OutboundTextMessageImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OutboundTextMessageImpl extends MessageImpl implements
	...
	public NotificationChain basicSetMessage(TextMessage newMessage,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					TeksPackage.OUTBOUND_TEXT_MESSAGE__MESSAGE, oldMessage,
					newMessage);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMessage(TextMessage newMessage) {
		if (newMessage != message) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeksPackage.OUTBOUND_TEXT_MESSAGE__MESSAGE, newMessage,
					newMessage));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case TeksPackage.OUTBOUND_TEXT_MESSAGE__MESSAGE:
