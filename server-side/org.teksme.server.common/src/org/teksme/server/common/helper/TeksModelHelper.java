...
import org.teksme.server.ServiceLocator;
import org.teksme.server.ServiceLocatorException;
...
public class TeksModelHelper {
	...
	public Teks createTeksModelFromXml(String xmlInput) throws IOException {
		...
		//
		// InputStream is = new
		// ByteArrayInputStream(xmlInput.getBytes("ASCII"));
		//
	...
	public void serializeTeksModelXMLData(String xmlInput, String filePath) throws IOException {
		...
		PrintWriter fileWriter = new PrintWriter(new BufferedWriter(new FileWriter(filePath)));
