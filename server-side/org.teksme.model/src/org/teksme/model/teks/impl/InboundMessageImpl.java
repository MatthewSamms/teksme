 ...
 *   <li>{@link org.teksme.model.teks.impl.InboundMessageImpl#getOriginator <em>Originator</em>}</li>
 *   <li>{@link org.teksme.model.teks.impl.InboundMessageImpl#getSmscNumber <em>Smsc Number</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InboundMessageImpl extends MessageImpl implements InboundMessage {
	...
	public void setOriginator(String newOriginator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeksPackage.INBOUND_MESSAGE__ORIGINATOR, oldOriginator,
					originator));
	}
	...
	public void setSmscNumber(String newSmscNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TeksPackage.INBOUND_MESSAGE__SMSC_NUMBER, oldSmscNumber,
					smscNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case TeksPackage.INBOUND_MESSAGE__ORIGINATOR:
			return getOriginator();
		case TeksPackage.INBOUND_MESSAGE__SMSC_NUMBER:
