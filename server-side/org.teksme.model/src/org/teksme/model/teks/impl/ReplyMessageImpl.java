 ...
 * @generated
 */
public class ReplyMessageImpl extends EObjectImpl implements ReplyMessage {
	/**
	 ...
	 * @ordered
	 */
	protected OutboundTextMessage customMessage;
	 ...
	 * @generated
	 */
	public OutboundTextMessage getCustomMessage() {
		if (customMessage != null && customMessage.eIsProxy()) {
			InternalEObject oldCustomMessage = (InternalEObject) customMessage;
			customMessage = (OutboundTextMessage) eResolveProxy(oldCustomMessage);
	 ...
	 * @generated
	 */
	public OutboundTextMessage basicGetCustomMessage() {
		return customMessage;
	}
	...
	public NotificationChain basicSetCustomMessage(
			OutboundTextMessage newCustomMessage, NotificationChain msgs) {
		OutboundTextMessage oldCustomMessage = customMessage;
	 ...
	 * @generated
	 */
	public void setCustomMessage(OutboundTextMessage newCustomMessage) {
	...
	public void eSet(int featureID, Object newValue) {
		...
		case TeksPackage.REPLY_MESSAGE__DEFAULT_MESSAGE:
			...
			return;
		case TeksPackage.REPLY_MESSAGE__CUSTOM_MESSAGE:
			setCustomMessage((OutboundTextMessage) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case TeksPackage.REPLY_MESSAGE__DEFAULT_MESSAGE:
			...
			return;
		case TeksPackage.REPLY_MESSAGE__CUSTOM_MESSAGE:
			setCustomMessage((OutboundTextMessage) null);
			return;
		}
